 ...
 *  2. typecheck — source/scripts solution plus every test;
 *  3. build — tsdown produces the self-contained node half;
 *  4. unit suite — vitest over a real Cordis context;
 *  5. config/package contracts — generated config is deterministic, the dev
 ...
 *  6. preset templates — both ids carry exactly one tool-retry placeholder row;
 *  7. official package — stable bundle id, dsh.bundle declaration, exact
