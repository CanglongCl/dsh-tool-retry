  ...
  return createUserMessage({
    ...
    content: [{
      ...
      text: [
        ...
        'then replace the fragment) and submit the corrected program as the new',
        'run (a program cannot call tools.run_code itself); or extract long',
        'argument data from it and pass it to other tools.',
      ].join('\n'),
    }],
  })
}
